...
// Override default configurations
            ...
            String jarName = this.artifactId+".jar";
        ...
        private static class AutoPlugPropertiesPlugin extends JPM.Plugin {
            public AutoPlugPropertiesPlugin() {
                ...
                onBeforeToXML((d) -> {
                    ...
                    XML pom = d.projectXml;
                    pom.put("properties java.version", d.project.javaVersion);
                    pom.put("properties version", d.project.version);
                    //         The main class or this jars entry point. Is optional.
                    pom.put("properties main-class", d.project.mainClass);
                    pom.put("properties slf4j.version", "2.0.13");
                    pom.put("properties name", d.project.artifactId);
                    ...
                    pom.put("properties installation-path", "./"+d.project.artifactId+".jar");
                });
            }
        }
    }
